class DateTimePicker{static defaultSettings={language:"en-US",firstDayOfWeek:0,showCalendar:!0,showDaysOfWeek:!0,showSliders:!0,showUTC:!0,showDOYtoggle:!1,mode:"inline",useBootstrap:!1,onDateSelect:null,onTimeChange:null,setNowIncludesTime:!1,slidersToShow:["hours","minutes"],showFooter:!0,showNowButton:!0,showSelectedDatetime:!0,showCloseButton:!0};constructor(e,t){this.settings={...DateTimePicker.defaultSettings,...t};const s=t?.initialValue?new Date(t.initialValue):new Date;this.selectedDate=isNaN(s.getTime())?new Date:s,this.container=null,this.init(e)}init(e){this.createPicker(e),this.populateDropdowns(),this.renderCalendar(),this.bindEvents(e),this.settings.mode==="inline"?(this.container.style.display="block",this.datetimePicker.style.display="block",this.datetimePicker.style.position="static"):(this.container.style.display="none",this.datetimePicker.style.display="none",this.datetimePicker.parentElement.style.display="none"),this.toggleFeatures()}createPicker(e){const t=document.createElement("div");t.classList.add("datetime-container"),t.style.display="none";const s=this.settings.useBootstrap?"datetime-picker border rounded shadow p-3 bg-body":"datetime-picker border rounded shadow p-3 bg-white";t.innerHTML=`
    ...
    `}getDOWHTML(){const e=document.createElement("div");e.id="days-of-week";const t=new Intl.DateTimeFormat(this.settings.language,{weekday:"short"}),s=Array.from({length:7},(l,n)=>t.format(new Date(2023,0,n+1))),i=this.settings.firstDayOfWeek,a=[...s.slice(i),...s.slice(0,i)];for(const l of a){const n=document.createElement("div");n.textContent=l,n.classList.add("dow-cell"),this.settings.useBootstrap&&n.classList.add("fw-bold"),e.appendChild(n)}return e.outerHTML}populateYearDropdown(){if(typeof this._yearRangeStart!="number"||typeof this._yearRangeEnd!="number"){const e=this.selectedDate.getFullYear(),t=20;this._yearRangeStart=e-Math.floor(t/2),this._yearRangeEnd=e+Math.floor(t/2)}this.renderYearOptions(this.selectedDate.getFullYear()),this._yearDropdownListenerAttached||(this.yearSelect.addEventListener("change",e=>this.handleYearSelection(e)),this._yearDropdownListenerAttached=!0)}renderYearOptions(e){const t=[];for(let s=this._yearRangeStart;s<=this._yearRangeEnd;s++)t.push(`<option value="${s}"${s===e?" selected":""}>${s}</option>`);this.yearSelect.innerHTML=t.join(""),this.yearSelect.value=e}handleYearSelection(e){const t=parseInt(e.target.value,10);t===this._yearRangeStart?this.loadMoreYears("backward",t):t===this._yearRangeEnd&&this.loadMoreYears("forward",t),this.selectedDate.setFullYear(t),this.renderCalendar(),this.updateSelectedDatetime()}loadMoreYears(e,t){e==="forward"?this._yearRangeEnd+=20:e==="backward"&&(this._yearRangeStart-=20),this.renderYearOptions(t),this.yearSelect.value=t}getCalendarHTML(){return'<div id="calendar" class="calendar mb-3" role="grid" aria-label="Calendar"></div>'}getSelectedTimeHTML(){return this.settings.showSelectedDatetime?`<div class="d-flex flex-row justify-content-between mb-1">
            ...
            </div>`:""}getSliderLabel(e){const t=this.settings.language;let s;switch(e){case"hours":return s=new Intl.NumberFormat(t,{style:"unit",unit:"hour",unitDisplay:"long"}).format(1),s.replace(/\d+/g,"").trim();case"minutes":return s=new Intl.NumberFormat(t,{style:"unit",unit:"minute",unitDisplay:"long"}).format(1),s.replace(/\d+/g,"").trim();case"seconds":return s=new Intl.NumberFormat(t,{style:"unit",unit:"second",unitDisplay:"long"}).format(1),s.replace(/\d+/g,"").trim();case"nanoseconds":return"nano"+new Intl.NumberFormat(t,{style:"unit",unit:"second",unitDisplay:"long"}).format(1).replace(/\d+/g,"").trim();default:return e}}getSlidersHTML(){const e=this.settings.useBootstrap?"slider-container mb-3":"slider-container",t=this.settings.slidersToShow.map(s=>{switch(s){case"hours":return this.getSliderHTML("hours",this.getSliderLabel("hours"),0,23);case"minutes":return this.getSliderHTML("minutes",this.getSliderLabel("minutes"),0,59);case"seconds":return this.getSliderHTML("seconds",this.getSliderLabel("seconds"),0,59);case"nanoseconds":return this.getSliderHTML("nanoseconds",this.getSliderLabel("nanoseconds"),0,999999999);default:return""}}).join("");return`<div class="${e}">${t}</div>`}getSliderHTML(e,t,s,i){const a=this.settings.useBootstrap?"form-label me-2":"",l=this.settings.useBootstrap?"form-range w-50 ms-auto":"";return`
                <div class="d-flex flex-row align-items-center">
                        <label for="${e}" class="${a}">${t}:</label>
                        <input type="range" id="${e}" value="0" min="${s}" max="${i}" step="1" class="${l}" aria-label="${t}">
                </div>
            `}getTogglesHTML(){const e=this.settings.useBootstrap?"form-check form-switch":"",t=this.settings.useBootstrap?"form-check-input":"",s=this.settings.useBootstrap?"form-check-label":"";return`
                <div class="toggle-container justify-content-between w-100">
                    <div class="${e}">
                        ...
                        <label for="utc-toggle" class="${s}">Local/UTC</label>
                    </div>
                    <div class="${e} mb-3">
